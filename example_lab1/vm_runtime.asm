...
vmco_ip_no_new_tick:
    ...
    ; continue same thread while left >= 1
    ldc r1, 1
    cmp r4, r1
    jl vmco_ip_maybe_switch
    jmp vmco_ip_ret

vmco_ip_maybe_switch:
    ; Budget exhausted -> switch by operations quantum.
    ; CyclesSignalPeriod still influences cadence indirectly:
    ; Makefile maps it to setThreadQuantumOps().
    jmp vmco_ip_switch
